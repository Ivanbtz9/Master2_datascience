...
Box.test(Rain, type="Ljung-Box", lag=5) #On ne rejette pas cette hypothèse
...
source("/home/ibotcazou/Bureau/Master_data_science/Master2_datascience/Série chronologiques_Proïa/Corrections
/TP4_CheckupRes.R")
